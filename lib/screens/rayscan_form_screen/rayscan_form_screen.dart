...
class RayscanFormScreen extends StatelessWidget {
  final RayScanProductType rayScanProductType;
  RayscanFormScreen({Key key, this.rayScanProductType}) : super(key: key);

  final controller = Get.isRegistered<RayScanController>()
      ? Get.find<RayScanController>()
      : Get.put(RayScanController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RayScanController>(
      builder: (_) {
        return SafeArea(
          child: Scaffold(
                            ...
                            Expanded(
                              child: NeuButton(
                                ...
                                onTap: () async {
                                  ...
                                  //   controller
                                  //       .handleGuestUser(rayScanProductType);
                                  //   return;
                                  // }
                                  if (rayScanProductType ==
                                      RayScanProductType.Yolo) {
                                    controller.getYoloXRay();
                                  }
                                  if (rayScanProductType ==
                                      RayScanProductType.GradCam) {
                                    controller.getGradCam();
                                  }
                                  if (rayScanProductType ==
                                      RayScanProductType.CTScan) {
                                    controller.getCTScan();
                                  }
                                },
